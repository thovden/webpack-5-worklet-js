window.start = () => {
  ...
  const audioWorklet = new URL("./recorder.worklet.js", import.meta.url);
  context.audioWorklet
    ...
    .then(() => {
      ...
      console.log("Strategy A Success - running audio worklet", recorderNode);
    })
  ...
  magicContextName
    ...
    .then(() => {
      ...
      console.log("Strategy B Success - running audio worklet", recorderNode);
    })
